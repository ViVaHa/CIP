...
/**
 * Created by vishnu on 21-03-2016.
 */
...
public class BorrowActivity extends AsyncTask<String, Void, String> {

    private Context context;

    public BorrowActivity(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            link = "http://selvakanesh07.esy.es/pupdate1.php" + data;
